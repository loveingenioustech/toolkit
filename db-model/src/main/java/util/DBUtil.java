...
public class DBUtil {
	...
	public static Table reverseTable(String tableName) throws Exception {
	...
	public static Table reverseTable(String tableName, Schema schema)
		...
		conn = DBUtil.getDBConnection(schema);

		return reverseTable(tableName, conn);
	...
	public static Table reverseTable(String tableName, Connection conn)
			throws SQLException {
		Table table = null;
		List<Column> colList = null;
		ResultSet rs = null;
